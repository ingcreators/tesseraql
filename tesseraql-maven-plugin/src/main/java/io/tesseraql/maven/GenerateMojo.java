 ...
 * document and the htmx server contract. The Simple YAML routes stay the source of truth;
 * reproducibility rests on the manifest checksum index and these byte-stable derivations.
 */
