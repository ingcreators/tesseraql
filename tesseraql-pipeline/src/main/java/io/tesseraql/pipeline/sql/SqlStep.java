                            ...
                            bound, (resultSet, span) -> {
                                ...
                                try (writer) {
                                    io.tesseraql.core.files.ResultSetRows extraction = new io.tesseraql.core.files.ResultSetRows(
                                            ...
                                            EXECUTION_ERROR);
                                    // A failure inside the write is the document's, not the
                                    // statement's: ExportWrite files it under its own code
                                    // for every surface, and the catch-all below
                                    // passes a shaped failure through as itself.
