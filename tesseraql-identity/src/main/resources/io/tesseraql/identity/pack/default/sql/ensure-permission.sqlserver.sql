...
using (select /* permissionId */ 'tql.ops.view.*' as permission_id,
              /* permissionCode */ 'tql.ops.view.*' as permission_code,
              /* permissionName */ 'tql.ops.view.*' as permission_name) as s
