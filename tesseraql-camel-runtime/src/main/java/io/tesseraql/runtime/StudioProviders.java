...
import static io.tesseraql.runtime.TesseraqlRuntime.DATA_EDIT_SLOTS;
import static io.tesseraql.runtime.TesseraqlRuntime.DATA_FILTER_SLOTS;
import static io.tesseraql.runtime.TesseraqlRuntime.LOG;
import static io.tesseraql.runtime.TesseraqlRuntime.MENU_ICON_OPTIONS;
import static io.tesseraql.runtime.TesseraqlRuntime.ROUTE_FORM_INPUT_SLOTS;
import static io.tesseraql.runtime.TesseraqlRuntime.ROW_EDIT_REJECTED;
import static io.tesseraql.runtime.TesseraqlRuntime.actorOf;
import static io.tesseraql.runtime.TesseraqlRuntime.dataFilters;
import static io.tesseraql.runtime.TesseraqlRuntime.dataQueryBase;
import static io.tesseraql.runtime.TesseraqlRuntime.dataRowKey;
import static io.tesseraql.runtime.TesseraqlRuntime.menuIndex;
import static io.tesseraql.runtime.TesseraqlRuntime.menuVisibility;
import static io.tesseraql.runtime.TesseraqlRuntime.parseIndex;
import static io.tesseraql.runtime.TesseraqlRuntime.parseJsonObject;
import static io.tesseraql.runtime.TesseraqlRuntime.parsePage;
import static io.tesseraql.runtime.TesseraqlRuntime.parseQueryString;
import static io.tesseraql.runtime.TesseraqlRuntime.putIfPresent;
import static io.tesseraql.runtime.TesseraqlRuntime.rebindPolicyEngine;
import static io.tesseraql.runtime.TesseraqlRuntime.requireCopilot;
import static io.tesseraql.runtime.TesseraqlRuntime.requireExplicitConfirm;
import static io.tesseraql.runtime.TesseraqlRuntime.requiredParam;
import static io.tesseraql.runtime.TesseraqlRuntime.str;
import static io.tesseraql.runtime.TesseraqlRuntime.tryInvoke;
import static io.tesseraql.runtime.TesseraqlRuntime.urlEncode;
...
final class StudioProviders {
    ...
    static void register(io.tesseraql.core.service.ServiceProviders serviceProviders, Deps deps) {
        ...
        io.tesseraql.studio.CopilotService copilotService = deps.copilotService();
        io.tesseraql.studio.StudioService.FieldMask studioMask = deps.studioMask();
        io.tesseraql.studio.StudioService.PdfRender studioPdf = deps.studioPdf();
        boolean scaffoldEnabled = deps.scaffoldEnabled();
        boolean testRunnerEnabled = deps.testRunnerEnabled();
        RouteReloader reloader = deps.reloader();
