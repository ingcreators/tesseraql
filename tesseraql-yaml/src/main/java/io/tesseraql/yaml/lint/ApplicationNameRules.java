 ...
 * {@code tql.ops.view.<name>} grants are checked against, it names the MCP server, and in a stack
 * it is the application's address. It used to default to the literal {@code app}, which made the value
