...
class FieldPolicyApplierTest {
    ...
    void hidesInvisibleField() {
        FieldPolicyApplier applier = new FieldPolicyApplier(
                Map.of("salary", new FieldPolicy(false, null, null, null)), null, null);
    ...
    void masksByStrategy() {
        FieldPolicyApplier applier = new FieldPolicyApplier(
                Map.of("email", new FieldPolicy(null, null, "email", null)), null, null);
    ...
    void hidesPolicyGatedFieldWhenDenied() {
        ...
        FieldPolicyApplier applier = new FieldPolicyApplier(
                Map.of("salary", new FieldPolicy(null, "users.readSensitive", null, null)),
                engine, principal);
