...
`http:` step — and a configured copilot whose host is not allow-listed fails the
boot with `TQL-SEC-4094`, an error that names the host and the YAML to add. Configuring
