...
| Secret hygiene in development | met | `SECURITY.md` — never commit secrets; keep credential directories away from coding agents (Claude Code's Bash sandbox denies them on the host) |
