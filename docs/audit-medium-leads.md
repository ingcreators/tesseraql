...
| 9 | The CLI refuses before it works | F114 | M | Unblocked: decision 1 below was taken 2026-09-09 (refusal 2, unreachable database 1); `docs/cli-surface.md` still says "exit" nowhere. |
