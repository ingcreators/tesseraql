...
| F127 bundled apps hard-coded English | **LIVE (reframed)** | medium | class GREW in-window; the end-user apps fixed, slice 8b; the operator apps are 8c |
