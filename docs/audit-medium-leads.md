...
11. **Studio's "Download CSV" was `Map.toString()`** since #220 on all three branches — the
    ...
    (#nnnn): the provider returns the string; the guards pin byte 0, the final CRLF, the two note
