...
| F82 README front-door drift | **LIVE (reframed)** | medium | partially killed; the residue fixed, slice 10 (the framework defect is slice 2 of its own campaign, decision 3) |
