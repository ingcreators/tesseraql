...
| `tesseraql.http.outbound` | [HttpOutbound.java](https://github.com/ingcreators/tesseraql/blob/main/tesseraql-yaml/src/main/java/io/tesseraql/yaml/http/HttpOutbound.java) | [authentication](authentication.md), [connectors](connectors.md), [copilot](copilot.md), +4 more |
