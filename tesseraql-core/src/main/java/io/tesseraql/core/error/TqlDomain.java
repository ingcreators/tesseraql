...
public enum TqlDomain {
    YAML, SQL, ROUTE, SEC, IAM, SAML, SCIM, OIDC, OAUTH, TENANT, APP, FIELD, MASK, RATE, BATCH, SPOOL, OTEL, STUDIO, REPORT, COMPAT, UPGRADE, PLUGIN, GOV, LD, LANE, TPL, COMP, IDEM, MCP, WORKFLOW, VIEW, ACCOUNT, DECISION
}
