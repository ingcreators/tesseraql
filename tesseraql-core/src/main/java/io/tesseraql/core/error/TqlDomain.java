...
public enum TqlDomain {
    YAML, SQL, CAMEL, SEC, IAM, SAML, SCIM, OIDC, TENANT, APP, FIELD, MASK, RATE, BATCH, SPOOL, OTEL, STUDIO, REPORT, COMPAT, UPGRADE, PLUGIN, PLAN, GOV, LD, LANE, TPL, COMP, IDEM, MCP, WORKFLOW, VIEW
}
